  ...
  return (
    <footer className="relative mt-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className={`absolute -top-24 -left-24 w-48 h-48 rounded-full ${
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
            ...
            <div className="flex-1 max-w-md">
              ...
              <div className="flex gap-4">
                {[
                  { Icon: IoLogoInstagram, color: 'text-pink-500 hover:text-pink-400', label: 'Instagram' },
                  { Icon: FaGithub, color: theme === 'dark' ? 'text-gray-400 hover:text-gray-300' : 'text-gray-600 hover:text-gray-800', label: 'GitHub' },
                  { Icon: FaLinkedin, color: 'text-blue-500 hover:text-blue-400', label: 'LinkedIn' }
                  ...
                  <Link
                    ...
                    aria-label={label}
                  >
                    <Icon className={`text-xl ${color} group-hover:scale-110 transition-all duration-300`} />
                  </Link>
                ))}
              </div>
            </div>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {['Technology', 'Design', 'Writing', 'Travel'].map((tag) => (
                    <Link
                      key={tag}
              ...
              <div>
                ...
                <div className="space-y-3">
                  {['Instagram', 'GitHub', 'LinkedIn', 'Newsletter'].map((social) => (
                    <Link
                      key={social}
                      href="#"
                      className={`block text-sm transition-all duration-300 hover:translate-x-2 ${
