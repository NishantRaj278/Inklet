...
function Footer() {
  return (
    <div className="p-32 w-full h-[300px] flex flex-col md:flex-row justify-around items-center mb-8">
      <div className="h-full w-full md:w-1/2 gap-2 flex flex-col">
        ...
        <div className="flex flex-col gap-4">
          <p>
            ...
            repudiandae ullam expedita, ut ipsam excepturi perspiciatis,
            explicabo sed similique est inventore cumque temporibus officiis
            asperiores facilis eius modi quo in?
          </p>
