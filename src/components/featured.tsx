...
function Featured() {
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-8 mb-20 mt-10 w-full h-screen">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full md:mt-20 mt-5 px-40">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start justify-center gap-4">
          ...
          <p className="text-lg font-medium">
            ...
            velit dicta iure neque, illum culpa maiores tempore eius saepe
            mollitia voluptas unde praesentium tenetur veniam molestias minus.
            Vel, modi deserunt?
          </p>
          <button className="bg-gray-600 px-4 py-2 text-white">
            Read More
          </button>
        </div>
      </div>
